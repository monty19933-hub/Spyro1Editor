...
4. In this first V5 lab, edit existing high-detail terrain height only. Save with
   **Save Research Workspace**.
5. Choose **Create Disposable Test CUE**, then **Reveal Test CUE** to select it
...
arbitrary Mobys or custom cross-level assets, portals, totals, music ownership,
and save ownership remain blocked until their own runtime tests pass.
