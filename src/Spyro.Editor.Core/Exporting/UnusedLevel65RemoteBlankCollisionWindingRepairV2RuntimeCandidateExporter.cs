...
internal sealed record UnusedLevel65RemoteBlankCollisionWindingRepairV2RuntimeCandidateRequest(
...
internal sealed record UnusedLevel65RemoteBlankCollisionWindingRepairV2RuntimeCandidatePaths(
    string OutputDirectoryPath,
    string OutputPrefix,
...
internal sealed record UnusedLevel65RemoteBlankCollisionWindingRepairV2RuntimeCandidateRawSectorDiff(
    int RawSectorLba,
...
internal sealed record UnusedLevel65RemoteBlankCollisionWindingRepairV2RuntimeCandidatePlan(
    int SchemaVersion,
    string ProfileId,
    ...
    UnusedLevel65RemoteBlankCollisionWindingRepairV2Proof CollisionWindingRepair,
    int WadLba,
    long DataWadOffset,
    int DataByteLength,
...
internal sealed record UnusedLevel65RemoteBlankCollisionWindingRepairV2RuntimeCandidateReceipt(
    int SchemaVersion,
    string ProfileId,
    string BaseImagePath,
    string BaseCuePath,
    ...
    int RepairChangedByteCount,
    int FailedV1OnlyAffectedRawSectorLba,
    bool FailedV1ToV2FourByteInverseVerified,
    long ChangedLogicalWadBytes,
    long ChangedPhysicalImageBytes,
    int RebuiltRawSectorCount,
    int ChangedRawSectorCount,
    IReadOnlyList<UnusedLevel65RemoteBlankCollisionWindingRepairV2RuntimeCandidateRawSectorDiff> RawSectorDiffs,
    string RawSectorDiffSha256,
...
internal sealed record UnusedLevel65RemoteBlankCollisionWindingRepairV2RuntimeCandidateResult(
    UnusedLevel65RemoteBlankCollisionWindingRepairV2RuntimeCandidatePaths Paths,
    UnusedLevel65RemoteBlankCollisionWindingRepairV2RuntimeCandidatePlan Plan,
    UnusedLevel65RemoteBlankCollisionWindingRepairV2RuntimeCandidateReceipt Receipt,
...
internal static class UnusedLevel65RemoteBlankCollisionWindingRepairV2RuntimeCandidateExporter
{
    public const string ProfileId =
        "unused-level-65-remote-blank-collision-winding-repair-sector216-clean-usa-disposable-v2";
    public const string OutputDirectoryName =
        "unused-level-65-remote-blank-collision-winding-repair-v2";
    public const string OutputPrefix =
        "Unused-Level-65-Remote-Blank-Collision-Winding-Repair-v2-Sector216-RUNTIME-CANDIDATE";

    private const int PlanSchemaVersion = 2;
    private const int ReceiptSchemaVersion = 3;
    private const int OperationJournalSchemaVersion = 1;
    private const string OperationKind =
        "unused-level-65-remote-blank-collision-winding-repair-v2-runtime-candidate";
    private const string OperationDirectoryPrefix = "remote-blank-winding-repair-v2-candidate-";
    ...
    private const string ActiveWriterLeaseMessage =
        "Another remote-blank v2 winding-repair runtime candidate writer is active for this publication parent. " +
    ...
    private const int WadLba = UnusedLevel65RemoteBlankCollisionWindingRepairV2Construction.WadLba;
    private const int WadByteLength = UnusedLevel65RemoteBlankCollisionWindingRepairV2Construction.WadByteLength;
    private const long DataWadOffset = UnusedLevel65RemoteBlankCollisionWindingRepairV2Construction.DataWadOffset;
    private const int DataByteLength = UnusedLevel65RemoteBlankCollisionWindingRepairV2Construction.DataByteLength;
    private const long ModelWadOffset = UnusedLevel65RemoteBlankCollisionWindingRepairV2Construction.ModelWadOffset;
    private const int ModelByteLength = UnusedLevel65RemoteBlankCollisionWindingRepairV2Construction.ModelByteLength;
    ...
    private const string RejectedFailedV1OutputImageSha256 =
        "8020947d4ab5e7e4b0eac4bc6409ff3d6f11212b0e118bbf007d870812014a8e";
    private const string ExpectedOutputDataSha256 =
        UnusedLevel65RemoteBlankCollisionWindingRepairV2Construction.ExpectedOutputDataSha256;
    private const long ExpectedChangedLogicalWadBytes = 484_336;
    private const long ExpectedChangedPhysicalImageBytes = 564_799;
    ...
    public static async Task<UnusedLevel65RemoteBlankCollisionWindingRepairV2RuntimeCandidateResult> CreateAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        UnusedLevel65RemoteBlankCollisionWindingRepairV2RuntimeCandidatePaths paths = CreatePaths(
        ...
        UnusedLevel65RemoteBlankCollisionWindingRepairV2StaticPlan construction =
            UnusedLevel65RemoteBlankCollisionWindingRepairV2Construction.BuildStaticPlan(baseImage);
        UnusedLevel65RemoteBlankCollisionWindingRepairV2StaticPlan constructionRepeated =
            UnusedLevel65RemoteBlankCollisionWindingRepairV2Construction.BuildStaticPlan(baseImage);
        ...
        UnusedLevel65RemoteBlankCollisionWindingRepairV2RuntimeCandidateResult? result = null;
    ...
    internal static async Task<UnusedLevel65RemoteBlankCollisionWindingRepairV2RuntimeCandidateResult> VerifyPublishedAsync(
        UnusedLevel65RemoteBlankCollisionWindingRepairV2RuntimeCandidatePaths paths,
        CancellationToken cancellationToken = default)
    {
        ArgumentNullException.ThrowIfNull(paths);
        cancellationToken.ThrowIfCancellationRequested();
        UnusedLevel65RemoteBlankCollisionWindingRepairV2RuntimeCandidatePaths exactPaths =
        ...
        UnusedLevel65RemoteBlankCollisionWindingRepairV2RuntimeCandidateReceipt receipt =
            await ReadCanonicalJsonAsync<UnusedLevel65RemoteBlankCollisionWindingRepairV2RuntimeCandidateReceipt>(
        ...
        UnusedLevel65RemoteBlankCollisionWindingRepairV2RuntimeCandidatePlan plan =
            await ReadCanonicalJsonAsync<UnusedLevel65RemoteBlankCollisionWindingRepairV2RuntimeCandidatePlan>(
        ...
        UnusedLevel65RemoteBlankCollisionWindingRepairV2RuntimeCandidatePlan expectedPlan =
    ...
    public static UnusedLevel65RemoteBlankCollisionWindingRepairV2RuntimeCandidatePaths CreatePaths(
        string outputDirectoryPath)
    {
        ...
        UnusedLevel65RemoteBlankCollisionWindingRepairV2RuntimeCandidatePaths result = new(
            outputDirectory,
            prefix,
            prefix + ".bin",
            prefix + ".cue",
            ...
            Path.Combine(parent, ".unused-level-65-remote-blank-winding-repair-v2-operations"));
    ...
    private static async Task<StagedCandidate> BuildAndVerifyStagedCandidateAsync(
        string baseImage,
        string baseCue,
        UnusedLevel65RemoteBlankCollisionWindingRepairV2RuntimeCandidatePaths finalPaths,
        ...
        CancellationToken cancellationToken)
    {
        ...
        UnusedLevel65RemoteBlankCollisionWindingRepairV2RuntimeCandidateReceipt receipt = new(
            ...
            construction.Repair.FailedV1OutputDataSha256,
            construction.Repair.FailedV1OutputModelSha256,
            construction.Repair.RepairDiffManifestSha256,
            construction.Repair.ChangedByteCount,
            construction.Repair.OnlyAffectedRawSectorLba,
            FailedV1ToV2FourByteInverseVerified: true,
            readback.ChangedLogicalWadBytes,
            readback.ChangedPhysicalImageBytes,
        ...
        CancellationToken cancellationToken)
    {
        ...
        byte[] reapplied = UnusedLevel65RemoteBlankCollisionWindingRepairV2Construction.ApplyTransactional(
            construction,
            construction.SourceData,
            reverse: false);
        byte[] inverse = UnusedLevel65RemoteBlankCollisionWindingRepairV2Construction.ApplyTransactional(
            construction,
            outputData,
            reverse: true);
        byte[] repairedFromFailedV1 =
            UnusedLevel65RemoteBlankCollisionWindingRepairV2Construction.ApplyRepairTransactional(
                construction.FailedV1OutputData,
                construction.Repair.RepairRanges,
                reverse: false);
        byte[] failedV1Inverse =
            UnusedLevel65RemoteBlankCollisionWindingRepairV2Construction.ApplyRepairTransactional(
                outputData,
                construction.Repair.RepairRanges,
                reverse: true);
        if (!reapplied.SequenceEqual(outputData) ||
            !inverse.SequenceEqual(construction.SourceData) ||
            !repairedFromFailedV1.SequenceEqual(outputData) ||
            !failedV1Inverse.SequenceEqual(construction.FailedV1OutputData) ||
            !outputData.AsSpan(
                    UnusedLevel65RemoteBlankCollisionWindingRepairV2Construction.TriangleDataRelativeOffset,
                    12)
                .SequenceEqual(Convert.FromHexString("10011C701001380000020000")))
        {
        ...
        byte[] outputModel = outputData.AsSpan(
            UnusedLevel65RemoteBlankCollisionWindingRepairV2Construction.ModelDataRelativeOffset,
        ...
        if (!construction.Spawn.AtomicXyOnly ||
            construction.Spawn.LandingRawX != UnusedLevel65RemoteBlankCollisionWindingRepairV2Construction.AuthoredRawX ||
            construction.Spawn.LandingRawY != UnusedLevel65RemoteBlankCollisionWindingRepairV2Construction.AuthoredRawY ||
            construction.Spawn.PlayerRawX != UnusedLevel65RemoteBlankCollisionWindingRepairV2Construction.AuthoredRawX ||
            construction.Spawn.PlayerRawY != UnusedLevel65RemoteBlankCollisionWindingRepairV2Construction.AuthoredRawY ||
    ...
    private static UnusedLevel65RemoteBlankCollisionWindingRepairV2RuntimeCandidatePlan BuildPublishedPlan(
        UnusedLevel65RemoteBlankCollisionWindingRepairV2StaticPlan construction,
    ...
    private static void ValidateConstructionGate(UnusedLevel65RemoteBlankCollisionWindingRepairV2StaticPlan construction)
    {
        if (construction.ProfileId != UnusedLevel65RemoteBlankCollisionWindingRepairV2Construction.ProfileId ||
            ...
            construction.DiffManifestSha256 != UnusedLevel65RemoteBlankCollisionWindingRepairV2Construction.ExpectedDiffManifestSha256 ||
            construction.DeterministicPlanSha256 != UnusedLevel65RemoteBlankCollisionWindingRepairV2Construction.ExpectedDeterministicPlanSha256 ||
            ...
            construction.Scene.NewSectorSha256 != UnusedLevel65RemoteBlankCollisionWindingRepairV2Construction.ExpectedNewSectorSha256 ||
            ...
            construction.Collision.OutputTriangleHex != "10011C701001380000020000" ||
            ...
            construction.ChangedDataByteCount != UnusedLevel65RemoteBlankCollisionWindingRepairV2Construction.ExpectedChangedDataByteCount ||
            construction.DiffRanges.Count != UnusedLevel65RemoteBlankCollisionWindingRepairV2Construction.ExpectedDiffRangeCount ||
            construction.Repair.FailedV1ProfileId != UnusedLevel65RemoteBlankIsolationConstruction.ProfileId ||
            construction.Repair.FailedV1OutputDataSha256 !=
            ...
            construction.Repair.CollisionTriangleIndex != 13_995 ||
            construction.Repair.TriangleDataRelativeOffset !=
                UnusedLevel65RemoteBlankCollisionWindingRepairV2Construction.TriangleDataRelativeOffset ||
            construction.Repair.OnlyAffectedRawSectorLba != 54_581 ||
            construction.Repair.FailedV1TriangleHex != "100138381001007000020000" ||
            construction.Repair.RepairedTriangleHex != "10011C701001380000020000" ||
            construction.Repair.FailedV1NormalZ != 50_176 ||
            construction.Repair.RepairedNormalZ != -50_176 ||
            construction.Repair.ChangedByteCount != 4 ||
            construction.Repair.RepairRangeCount != 2 ||
            construction.Repair.RepairDiffManifestSha256 !=
                UnusedLevel65RemoteBlankCollisionWindingRepairV2Construction.ExpectedRepairDiffManifestSha256 ||
            !construction.Repair.ExactFailedV1OutputConsumed ||
            !construction.Repair.FourByteAllowlistComplete ||
            !construction.Repair.ByteInverseVerified ||
            !construction.Repair.PointSetIdentical ||
            !construction.Repair.AcbOrderVerified ||
            !construction.Repair.CollisionTreeIdentical ||
            !construction.Repair.CollisionBlocksIdentical ||
            !construction.Repair.CollisionAssignmentIdentical ||
            !construction.Repair.OcclusionIdentical ||
            !construction.Repair.SpawnIdentical ||
            !construction.Repair.ProtectedDataIdentical ||
            construction.Repair.FailedV1ArtifactMutationPossible ||
            !construction.Repair.RequiresDuckStationRuntimeProof ||
            construction.Repair.PromotionAuthorized ||
            construction.Repair.NormalCreateBinEnabled ||
        ...
        {
            throw new InvalidDataException("The exact static ID65 remote-blank v2 winding-repair gate is not satisfied.");
        }
    ...
    private static void ValidateConstructionDeterminism(
        UnusedLevel65RemoteBlankCollisionWindingRepairV2StaticPlan first,
        UnusedLevel65RemoteBlankCollisionWindingRepairV2StaticPlan second)
    {
        if (first.SourceImageSha256 != second.SourceImageSha256 ||
            ...
            first.Repair.RepairDiffManifestSha256 != second.Repair.RepairDiffManifestSha256 ||
            first.Repair.FailedV1NormalZ != second.Repair.FailedV1NormalZ ||
            first.Repair.RepairedNormalZ != second.Repair.RepairedNormalZ ||
            ...
            !first.FailedV1OutputData.SequenceEqual(second.FailedV1OutputData) ||
    ...
    private static bool IsExactDisposableRuntimeCandidateAuthorized(
        UnusedLevel65RemoteBlankCollisionWindingRepairV2StaticPlan construction) =>
        construction.ProfileId == UnusedLevel65RemoteBlankCollisionWindingRepairV2Construction.ProfileId &&
        construction.SourceImageSha256 == BaseImageSha256 &&
        construction.OutputDataSha256 == ExpectedOutputDataSha256 &&
        construction.Scene.NewSectorIndex == 216 &&
        construction.Scene.ExactHpLpPairing &&
    ...
    {
        StringBuilder builder = new();
        builder.AppendLine("# ID65 Remote Blank-Looking Pad v2 Winding Repair — Disposable Runtime Checklist");
        builder.AppendLine();
        builder.AppendLine(
        ...
        builder.AppendLine(
            "It is the isolated A,C,B winding discriminator for the failed v1 no-landing/Game Over result: " +
            "only four packed T13995 bytes change, all in raw sector LBA 54581.");
        builder.AppendLine(
        ...
        builder.AppendLine(
            $"**DO NOT LOAD OR RETEST failed v1** `{RejectedFailedV1OutputImageSha256}`. " +
            "It is retained only as rejected no-landing/Game Over evidence.");
        builder.AppendLine();
        if (finderReveal != null)
        {
        ...
        builder.AppendLine(
            $"- Failed-v1 row-80/model SHA-256: " +
            $"`{UnusedLevel65RemoteBlankCollisionWindingRepairV2Construction.ExpectedFailedV1OutputDataSha256}` / " +
            $"`{UnusedLevel65RemoteBlankCollisionWindingRepairV2Construction.ExpectedFailedV1OutputModelSha256}`");
        builder.AppendLine(
            "- Repair-only delta: `4` bytes, `2` guarded ranges, T13995 `A,B,C` → `A,C,B`, " +
            "decoded normal Z `+50176` → `-50176`, only raw sector `LBA 54581` versus failed v1.");
        ...
        builder.AppendLine();
        builder.AppendLine("- [ ] **Initial lives + completed landing:** the HUD shows exactly `4` lives, the entry/fly-in fully completes, and controllable Spyro is visibly resting on the authored pad before any movement input.");
        builder.AppendLine("- [ ] **20-second hands-off stability:** after completed landing, provide no movement input for at least `20` continuous real-time seconds; lives remain `4`, control remains available, and no spontaneous fall, death, respawn, or Game Over occurs.");
        builder.AppendLine("- [ ] **Lone-pad visibility:** after the 20-second stability hold, one small triangular pad is visible and no inherited terrain or Mobys are visibly connected to it.");
        ...
        builder.AppendLine("- [ ] **One deliberate fall + exact respawn:** only after the stable/movement gates, deliberately leave one edge once; confirm one completed death changes lives exactly `4 → 3`, then controllable Spyro returns to the same isolated pad at the same yaw/orientation without a warp or save state.");
        builder.AppendLine("- [ ] **Remaining edge controls:** use separate cold runs for the other two edges; report each clean departure independently and do not substitute these extra falls for the required first `4 → 3` discriminator.");
        ...
        builder.AppendLine();
        builder.AppendLine("- **Far LP is unclaimable in this discriminator:** this small pad and ordinary camera distance cannot prove the far low-detail route. Do not report an LP pass from this candidate; a separate instrumented large-distance runtime gate is required.");
    ...
    private static string BuildLocationGuideSvg(IReadOnlyList<RuntimeCandidateLoadCode> loadCodes)
    {
        ...
        "  <text x=\"60\" y=\"58\" fill=\"#ffffff\" font-family=\"Helvetica,Arial,sans-serif\" font-size=\"31\" font-weight=\"700\">ID65 Remote Blank Pad v2 Winding Repair</text>\n" +
        ...
        "  <text x=\"820\" y=\"232\" fill=\"#d8e3fa\" font-family=\"Helvetica,Arial,sans-serif\" font-size=\"14\">One fall • lives 4→3 • same pad/yaw</text>\n" +
        "  <text x=\"90\" y=\"510\" fill=\"#9fb3da\" font-family=\"Menlo,monospace\" font-size=\"13\">Pad points: (272,272,512)  (496,272,512)  (384,496,512)</text>\n" +
        "  <text x=\"60\" y=\"578\" fill=\"#ffcf70\" font-family=\"Helvetica,Arial,sans-serif\" font-size=\"14\" font-weight=\"700\">Cards 1/2: None • Do not save • Cold boot • Cheats off • Load paired CUE</text>\n" +
        "  <text x=\"60\" y=\"601\" fill=\"#d8e3fa\" font-family=\"Helvetica,Arial,sans-serif\" font-size=\"14\">Gate 1: HUD lives exactly 4 • entry fully completes • Spyro visibly lands before input</text>\n" +
        "  <text x=\"60\" y=\"624\" fill=\"#d8e3fa\" font-family=\"Helvetica,Arial,sans-serif\" font-size=\"14\">Gate 2: hands off ≥20 continuous seconds • lives stay 4 • no spontaneous death</text>\n" +
        "  <text x=\"60\" y=\"647\" fill=\"#d8e3fa\" font-family=\"Helvetica,Arial,sans-serif\" font-size=\"14\">Gate 3: one deliberate fall • lives 4→3 • same pad + same yaw respawn</text>\n" +
        "  <text x=\"60\" y=\"670\" fill=\"#ff9c9c\" font-family=\"Helvetica,Arial,sans-serif\" font-size=\"13\">Far LP UNCLAIMABLE on this small pad • separate instrumented large-distance gate required</text>\n" +
        $"  <text x=\"60\" y=\"693\" fill=\"#ff9c9c\" font-family=\"Menlo,monospace\" font-size=\"10\">DO NOT LOAD/RETEST failed v1: {RejectedFailedV1OutputImageSha256}</text>\n" +
        "  <text x=\"60\" y=\"721\" fill=\"#ffffff\" font-family=\"Helvetica,Arial,sans-serif\" font-size=\"15\" font-weight=\"700\">Pinned candidate identity</text>\n" +
        $"  <text x=\"60\" y=\"741\" fill=\"#8fa8d8\" font-family=\"Menlo,monospace\" font-size=\"10\">Profile: {ProfileId}</text>\n" +
        $"  <text x=\"60\" y=\"759\" fill=\"#8fa8d8\" font-family=\"Menlo,monospace\" font-size=\"10\">CUE: {XmlEscape(OutputPrefix + ".cue")}</text>\n" +
        $"  <text x=\"60\" y=\"777\" fill=\"#ff9c9c\" font-family=\"Menlo,monospace\" font-size=\"10\">BIN SHA-256: {ExpectedOutputImageSha256}</text>\n" +
        "  <text x=\"1040\" y=\"777\" fill=\"#ff9c9c\" font-family=\"Menlo,monospace\" font-size=\"10\" font-weight=\"700\">UNPROMOTED</text>\n" +
        "  <text x=\"60\" y=\"806\" fill=\"#ffffff\" font-family=\"Helvetica,Arial,sans-serif\" font-size=\"15\" font-weight=\"700\">Full comparison load codes</text>\n" +
        $"  <text x=\"80\" y=\"830\" fill=\"#c8d6f4\" font-family=\"Menlo,monospace\" font-size=\"10\">{codeRows[0]}</text>\n" +
        $"  <text x=\"80\" y=\"852\" fill=\"#c8d6f4\" font-family=\"Menlo,monospace\" font-size=\"10\">{codeRows[1]}</text>\n" +
        $"  <text x=\"80\" y=\"874\" fill=\"#c8d6f4\" font-family=\"Menlo,monospace\" font-size=\"10\">{codeRows[2]}</text>\n" +
        $"  <text x=\"80\" y=\"896\" fill=\"#c8d6f4\" font-family=\"Menlo,monospace\" font-size=\"10\">{codeRows[3]}</text>\n" +
        "  <text x=\"60\" y=\"940\" fill=\"#aebfe1\" font-family=\"Helvetica,Arial,sans-serif\" font-size=\"11\">Report completed landing, 20-second stability, one 4→3 fall/respawn, movement, reset, and retail controls separately.</text>\n" +
        "</svg>\n";
    }
        ...
        UnusedLevel65RemoteBlankCollisionWindingRepairV2RuntimeCandidatePaths paths)
    {
        ...
        [
            ...
            OutputCollisionTreeSha256,
            UnusedLevel65RemoteBlankCollisionWindingRepairV2Construction.ExpectedFailedV1OutputDataSha256,
            "only four packed T13995 bytes change",
            "A,B,C` → `A,C,B",
            "`+50176` → `-50176`",
            "LBA 54581",
            ...
            RejectedFailedV1OutputImageSha256,
    ...
    private static void VerifyLocationGuide(string svg)
    {
        string[] required =
        [
            "ID65 Remote Blank Pad v2 Winding Repair",
            "Sector 216",
            "one isolated HP + LP pad",
            "Rotate camera 360° twice",
            "Walk • charge • jump",
            "HUD lives exactly 4",
            "hands off ≥20 continuous seconds",
            "one deliberate fall",
            "lives 4→3",
            "same pad + same yaw respawn",
            "Cards 1/2: None",
            "Do not save",
            "Far LP UNCLAIMABLE on this small pad",
            "DO NOT LOAD/RETEST failed v1",
            RejectedFailedV1OutputImageSha256,
        ...
        bool includeFinderReveal)
    {
        ...
        if (receipt.SchemaVersion != ReceiptSchemaVersion ||
            ...
            receipt.FailedV1OutputDataSha256 !=
                UnusedLevel65RemoteBlankCollisionWindingRepairV2Construction.ExpectedFailedV1OutputDataSha256 ||
            receipt.FailedV1OutputModelSha256 !=
                UnusedLevel65RemoteBlankCollisionWindingRepairV2Construction.ExpectedFailedV1OutputModelSha256 ||
            receipt.RepairDiffManifestSha256 !=
                UnusedLevel65RemoteBlankCollisionWindingRepairV2Construction.ExpectedRepairDiffManifestSha256 ||
            receipt.RepairChangedByteCount != 4 ||
            receipt.FailedV1OnlyAffectedRawSectorLba != 54_581 ||
            !receipt.FailedV1ToV2FourByteInverseVerified ||
